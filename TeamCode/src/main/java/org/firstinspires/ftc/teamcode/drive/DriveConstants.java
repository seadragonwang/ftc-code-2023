...
public class DriveConstants {
    ...
    public static double GEAR_RATIO = 1.013; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 11.6; // millimeter
    ...
    public static double MAX_ANG_VEL = 3.897674345552661;
