...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double X_MULTIPLIER = 90/88.286665; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 90/88.4052346; // Multiplier in the Y direction
    public static double LATERAL_DISTANCE = 9.543767; // in; distance between the left and right wheels
